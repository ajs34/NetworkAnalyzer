...
public class CaptureSnapshot {
    ...
    public String[] generateSnapshot() {
        ...
        String[] snapshot;
        snapshot = new String[]{telephonyManager.getNetworkOperatorName(), getPower(), getLteSnr(), networkType(), String.valueOf(serviceState.getChannelNumber()), getCellId(), getTimeStamp(), getTimeStampint()};
        return snapshot;
    }
