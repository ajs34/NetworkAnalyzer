...
public class statisticsactivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityCompat.requestPermissions(this, new String[]{Manifest.permission.READ_PHONE_STATE, Manifest.permission.CHANGE_NETWORK_STATE, Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.ACCESS_COARSE_LOCATION, Manifest.permission.ACCESS_BACKGROUND_LOCATION, Manifest.permission.READ_EXTERNAL_STORAGE}, PackageManager.PERMISSION_GRANTED);
    ...
    private final View.OnClickListener textListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            new DatePickerDialog(mActivity, mDateDataSet, mCalendar.get(Calendar.YEAR), mCalendar.get(Calendar.MONTH), mCalendar.get(Calendar.DAY_OF_MONTH)).show();
        }
    };
    ...
    private final TimePickerDialog.OnTimeSetListener mTimeDataSet = new TimePickerDialog.OnTimeSetListener() {
        ...
        public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
            ...
            startDate = Long.valueOf(SimpleDateFormat.format(mCalendar.getTime()));
        }
    };
    ...
    private final View.OnClickListener textListener2 = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            new DatePickerDialog(mActivity, mDateDataSet2, m2Calendar.get(Calendar.YEAR), m2Calendar.get(Calendar.MONTH), m2Calendar.get(Calendar.DAY_OF_MONTH)).show();
        }
    };
    ...
    private final TimePickerDialog.OnTimeSetListener mTimeDataSet2 = new TimePickerDialog.OnTimeSetListener() {
        ...
        public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
            ...
            endDate = Long.valueOf(SimpleDateFormat.format(m2Calendar.getTime()));
