...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public Boolean insertuserdata(Long Time, String Operator, String NetworkType, Integer SignalPower, Integer SNR, Integer FrequencyBand, String CellID) {
    ...
    public LinkedList<Double> extractOperator(DBHelper DB, Long lower, Long upper) {
    ...
    public LinkedList<Double> extractNetworkType(DBHelper DB, Long lower, Long upper) {
        Cursor res = DB.getdata();
        LinkedList<Double> we = new LinkedList<Double>();
    ...
    //Average SNR
    public Double extractSNR(DBHelper DB, Long lower, Long upper) {
        Cursor res = DB.getdata();
        Integer SNR = 0;
        Integer i = 0;
        while (res.moveToNext()) {
    ...
    public Double extractSignalPowerOF2g(DBHelper DB, Long lower, Long upper) {
        Cursor res = DB.getdata();
        Double SigPower = 0.0;
        Integer i = 0;
        while (res.moveToNext()) {
    ...
    public Double extractSignalPowerOF3g(DBHelper DB, Long lower, Long upper) {
        Cursor res = DB.getdata();
        Double SigPower = 0.0;
        Integer i = 0;
        while (res.moveToNext()) {
    ...
    public Double extractSignalPowerOF4g(DBHelper DB, Long lower, Long upper) {
        Cursor res = DB.getdata();
        Double SigPower = 0.0;
        Integer i = 0;
        while (res.moveToNext()) {
